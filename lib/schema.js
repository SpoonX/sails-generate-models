...
function generateColumn(definition) {
  ...
  if (definition.column_default === 'CURRENT_TIMESTAMP') {
    column.defaultsTo = 'function() {return new Date();}';
    column.required = false;
  } else if (definition.column_default !== null) {
